...
let CompanyDatabase = class CompanyDatabase extends database_default_1.DatabaseDefault {
    constructor(sessionConnection) {
        super(company_entity_1.CompanyEntity, sessionConnection, 'id');
        this.sessionConnection = sessionConnection;
    }
};
CompanyDatabase = __decorate([
    common_1.Injectable(),
...
//# sourceMappingURL=company.database.js.map