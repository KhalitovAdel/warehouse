...
exports.UserPasswordDatabase = void 0;
...
let UserPasswordDatabase = class UserPasswordDatabase extends database_default_1.DatabaseDefault {
    constructor(sessionConnection) {
        super(user_password_entity_1.UserPasswordEntity, sessionConnection, 'userId');
        this.sessionConnection = sessionConnection;
    }
};
UserPasswordDatabase = __decorate([
    common_1.Injectable(),
...
exports.UserPasswordDatabase = UserPasswordDatabase;
//# sourceMappingURL=user-password.database.js.map